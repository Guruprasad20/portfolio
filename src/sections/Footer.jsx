    ...
    <Section>
      ...
      >
        <ul>
          ...
          <li>
            <a href="https://www.linkedin.com/in/gopalkrishna-rathod-41208321a/" target={"_blank"} rel="noreferrer">
              contact
            </a>
          </li>
          <li>
            <a href="https://www.instagram.com/gopalkrishna.rathod20/" target={"_blank"} rel="noreferrer">
              instagram
            </a>
          </li>
          <li>
        ...
        <Bottom>
          ...
          >
            Made with &hearts; by{" "}
            <a
              href="https://www.linkedin.com/in/gopalkrishna-rathod-41208321a/"
              target={"_blank"}
